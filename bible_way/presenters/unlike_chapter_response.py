...
class UnlikeChapterResponse:

    @staticmethod
    def chapter_unliked_successfully_response(chapter_id: str) -> Response:
        return Response(
            {
                "success": True,
                "message": "Chapter unliked successfully",
    ...
    def not_liked_response() -> Response:
        return Response(
            {
                "success": False,
                "error": "You haven't liked this chapter",

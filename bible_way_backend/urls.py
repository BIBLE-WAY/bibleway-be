...
urlpatterns = [
    ...
    path("post/details", get_post_by_id_view),
    ...
    # ==================== Chapter APIs ====================
    path("chapter/like", like_chapter_view),
    path("chapter/unlike", unlike_chapter_view),
    path("chapter/feedback/create", create_chapter_feedback_view),
    ...
    path("books/chapters/metadata", get_chapter_metadata_view),
    ...
    path("admin/promotion/delete", admin_delete_promotion_view),
    ...
    path("admin/book/chapter/bulk-delete", bulk_delete_chapters_view),
    ...
    path("admin/chapter/feedbacks", admin_get_chapter_feedbacks_view),
